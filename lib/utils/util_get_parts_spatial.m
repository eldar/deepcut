function [joints, parts, keypoints] = util_get_parts_spatial()
...
parts(11).id = 10; parts(11).pos = [12 8]; parts(11).xaxis = [8 12];
parts(12).id = 11; parts(12).pos = [13 8]; parts(12).xaxis = [8 13];
parts(13).id = 12; parts(13).pos = [3 8]; parts(13).xaxis = [8 2];
parts(14).id = 13; parts(14).pos = [4 8]; parts(14).xaxis = [8 3];
